...
path = r'C:/Users/O1000246/BUNGE/Dados Supply Origeo - Documentos/ETL/Bases/XML/jan24'
...
peso_volume_tratado = [[float(j) if j != '' else j for j in i] for i in peso_volume_tratado]

peso_volume_tratado = [sorted(i) for i in peso_volume_tratado]

peso_volume_tratado = [i[-1] if len(i) > 1 else i[0] for i in peso_volume_tratado]
...
cte.to_csv('C:/Users/O1000246/BUNGE/Dados Supply Origeo - Documentos/Projeto_Dados/Data/Output/fCTE.csv', index=False, decimal=',', encoding='latin-1')